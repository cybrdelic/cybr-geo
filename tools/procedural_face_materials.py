...
def skin_maps(out,anatomy,size=4096):
    ...
    lip_color=np.stack([.277+.008*meso,.112+.004*meso,.085+.004*meso],-1)
    ...
    rough-=.085*oil;rough=rough*(1-lips)+(.31+.02*meso)*lips
    ...
    height=height*(1-lips)+(.0045*lipfold+.0015*fine)*lips
