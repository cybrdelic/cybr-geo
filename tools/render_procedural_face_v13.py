...
def main():
    ...
    parser.add_argument('--eye-width',type=float,default=29.)
    parser.add_argument('--eye-opening',type=float,default=8.2)
    ...
    parser.add_argument('--nasal-projection',type=float,default=25.)
