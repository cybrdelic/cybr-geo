...
def materials(out,clay=False):
    ...
    dictionaries=[
        ...
        {'type':'principled','base_color':{'type':'rgb','value':[.38,.19,.145]},
         'roughness':.32,'specular':.34},
        {'type':'principled','base_color':{'type':'rgb','value':[.075,.024,.018]},
         'roughness':.48,'specular':.22},
