"""Build/export/render REACH-2 v6 exclusively through CYBR GEO public APIs."""
...
ENGINEERING=ROOT/'tools'/'reach2_cybrgeo_v6_engineering.py'
...
def main():
    ...
    r=load(RECIPE,'reach2_v6_recipe');e=load(ENGINEERING,'reach2_v6_eng')
    ...
    cameras={
      'hero':(31,18,155,(-15,8,-50)),
      'output':(-46,15,150,(-20,-15,-58)),
      'rear':(58,12,150,(-20,38,-58)),
    }
    ...
    manifest=dict(model=a.name,generated_imagery=False,geometry_api='cybrgeo.Assembly/cybrgeo.from_shape',render_api='cybrgeo.photoreal.render',renderer='V9',engineering_qualified=True,parts=len(a.parts),triangles=sum(len(p.faces) for p in a.parts),analytic_brep_parts=len(a.cad),aesthetic_family='CYBR ORBIT',selected_gear=r.GEAR_MODEL,selected_motor=r.MOTOR_MODEL)
